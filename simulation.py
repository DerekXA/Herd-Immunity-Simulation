...
class Simulation(object):
    ...
    def __init__(self, virus, pop_size, ammount_vacc, first_infected=1, average_interactions=100):
        self.virus = virus 
        self.pop_size = pop_size
        self.ammount_vacc = ammount_vacc
        ...
        self.file_name = "{}_simulation_pop_{}_vp_{}_infected_{}.txt".format(
            virus.virus_name, pop_size, ammount_vacc, first_infected)
        logger = Logger(self.file_name) 
        self.logger = logger
        logger.write_metadata(self.virus.virus_name, self.virus.repro_rate, self.virus.mortality_rate, self.pop_size, self.ammount_vacc, self.first_infected)
    ...
    def time_step(self):
        ...
        for person in self.current_infected:
            print(f'infected person: {person._id}')
            #every sick person should interact wit
